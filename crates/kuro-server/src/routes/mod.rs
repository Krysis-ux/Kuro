...
fn native_routes() -> Router<SharedState> {
    Router::new()
        ...
        .route("/api/tools/skills/upload", post(tools::upload_skill))
        .route("/api/tools/skills/import", post(tools::import_skills))
        .route("/api/tools/skills/{slug}", delete(tools::delete_skill))
